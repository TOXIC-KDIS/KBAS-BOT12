...
if (!text) return conn.reply(m.chat, `*تريد تحمل ماذا*\n*ارسل رابط الفيديو الي اريد*\n*مثال:*\n*${usedPrefix + command} https://vm.tiktok.com/*`, fkontak,  m)
if (!/(?:https:?\/{2})?(?:w{3}|vm|vt|t)?\.?tiktok.com\/([^\s&]+)/gi.test(text)) return conn.reply(m.chat, `*❐┃خطئ رابط غير صحيح┃❌ ❯*`, fkontak,  m)  
try {
await conn.reply(m.chat, `⌛ _جاري الارسال..._\n▰▰▱▱▱\nالفديو يرتسل ( احب اذكرك انا خالي المسئولية من ذنوب اغانيك ) 🔰`, fkontak,  m)  
